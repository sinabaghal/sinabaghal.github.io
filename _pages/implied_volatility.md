...
## The following code is not optimized and for clarity it's kept as-is. It solves for IV using a combination of bisection and Newton root finding algorithm. Index option data is collected from CBOE.com and those outside of the allowable range within the Black-Scholes framework are discarded. 
