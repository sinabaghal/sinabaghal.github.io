...
- [Method and design choices](#method-and-design-choices)
  ...
  - [Training](#training)
  - [Training setup and convergence](#training-setup-and-convergence)
...
<p align="center">
  <img src="figs/SDE.png" alt="forward and reverse SDE, Song et al. 2021">
</p>
<div align="center">
...
<p align="center">
  <img src="assets/legend.png" alt="tile key">
</p>
...
<p align="center">
  <img src="assets/training_curve.png" alt="training and validation loss against solvability over the training run">
</p>
...
<p align="center">
  <img src="assets/jsd_sample_size.png" alt="tile-pattern JSD against sample size, generated vs real held-out puzzles">
</p>
<div align="center">
...
Below are sample puzzles generated by the trained model. Difficulty is measured by the push-based search described earlier.


<p align="center">
  <img src="assets/generate_panel.gif" alt="generation">
</p>
<p align="center">
...
<p align="center">
  <img src="assets/solve_panel.gif" alt="playback">
</p>
<p align="center">
...
**Require:** Trained model $f_\theta$, $T = 100$ steps, temperature $\tau = 1.0$
...
<p align="center">
  <img src="assets/wallfix_fixed.png" alt="unsolvable puzzles repaired by removing one wall, each marked with the probability the model committed it at">
</p>
<div align="center">

*Nine unsolvable puzzles, each repaired by deleting one interior wall. The red outline marks the removed cell and the chip gives the probability the model assigned it when it was committed during generation. Measured on 11,288 unsolvable puzzles from a 50,000-sample run.*
...
<p align="center">
  <img src="assets/hamming.png" alt="nearest-neighbour Hamming distance to the training corpus">
</p>
<div align="center">
...
<p align="center">
  <img src="assets/temperature_sweep.png" alt="solvability and wall count against sampling temperature">
</p>
<div align="center">
